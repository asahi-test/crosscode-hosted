...
if (process.platform == 'darwin') {
  if (process.arch == 'x64')
    greenworks = require('./osx/greenworks-osx64');
  else if (process.arch == 'ia32')
    greenworks = require('./osx/greenworks-osx32');
} else if (process.platform == 'win32') {
  if (process.arch == 'x64')
    greenworks = require('./win64/greenworks-win64');
  else if (process.arch == 'ia32')
    greenworks = require('./win32/greenworks-win32');
} else if (process.platform == 'linux') {
  if (process.arch == 'x64')
    greenworks = require('./linux64/greenworks-linux64');
  else if (process.arch == 'ia32')
    greenworks = require('./linux32/greenworks-linux32');
}
